...
export const Card = ({ movie }) => {
  ...
  return (
    <div className="gms card shadow-md rounded-xl dark:bg-gray-900 overflow-hidden w-full relative">
      ...
      <Link to={`/movies/${id}`} className="absolute inset-0" title={title}></Link>
    </div>
  );
};
